...
//		mockMvc.perform(MockMvcRequestBuilders.get("/avis").accept(MediaType.TEXT_HTML))
...
//				.sessionAttr("joueur", joueur)
//				.param("jeu", String.valueOf(jeuService.recupererJeux().get(0).getId()))
